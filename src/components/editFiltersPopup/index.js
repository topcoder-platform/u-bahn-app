    ...
    const handleFilterValueChanged = (filter, newValue) => {
        ...
        if (newValue) {
            if (index === -1) {
                ...
                setSearchFilters({...search.filters, [filter]: {...search.filters[filter], active: true} })
            }
        } else {
            if (index !== -1) {
                setSelectedFilters(
                ...
                setSearchFilters({...search.filters, [filter]: {...search.filters[filter], active: false} })
            }
        }
    }
                ...
                <div className={styles.popupContent}>
                    ...
                    <div className={styles.popupFooter}>
                        <div className={styles.popupFooterContent}>
                            ...
                            <Button onClick={handleDone} className={style.doneButton}>Done</Button>
                        </div>
                    </div>
                </div>
            </div>
