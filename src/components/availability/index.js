...
export default function Availability({ availableSelected = false, unavailableSelected = false, selector }) {
    const search = useSearch();
    const [isAvailableSelected, setIsAvailableSelected] = useState(availableSelected);
    const [isUnavailableSelected, setIsUnavailableSelected] = useState(unavailableSelected);
    ...
    return (
        <div className={styles.availabilityContainer}>
            <div className={styles.availabilityItemLeft} onClick={handleAvailableClicked}>
                <div className={styles.availabilityItemGroup}>
                    <div className={isAvailableSelected ? styles.availabilityItemStateActive : styles.availabilityItemStateInactive}></div>
                    <div>Available</div>
                </div>
            </div>
            <div className={styles.availabilityItemRight} onClick={handleUnvailableClicked}>
                <div className={styles.availabilityItemGroup}>
                    <div className={isUnavailableSelected ? styles.availabilityItemStateActive : styles.availabilityItemStateInactive}></div>
                    <div>Unavailable</div>
                </div>
            </div>
        </div>
